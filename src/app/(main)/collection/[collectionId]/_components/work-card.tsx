...
export const WorkCard: FC<WorkCardProps> = ({ work }) => {
  return (
    <div className="flex flex-col gap-3">
      <div key={work.id} className="h-full rounded-xl border">
          ...
          <div className="flex flex-1 p-3">
            <div className="flex flex-col justify-center gap-2">
              <Link
                ...
                className="line-clamp-2 flex items-center font-semibold text-base transition-colors hover:text-diggraph-accent"
              >
                {work.title}
              </Link>
